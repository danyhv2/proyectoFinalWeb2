...
--
-- Host: localhost
-- Generation Time: Apr 15, 2015 at 06:34 AM
...
ALTER TABLE `usuarios`
 ADD PRIMARY KEY (`correo`,`userRole`), ADD UNIQUE KEY `cedula` (`cedula`), ADD KEY `id_role` (`userRole`);
...
--
ALTER TABLE `carreras`
MODIFY `id_carrera` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
