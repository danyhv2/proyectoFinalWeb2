...
--
-- Host: localhost
-- Generation Time: Apr 17, 2015 at 05:11 AM
...
INSERT INTO `cursos` (`id_curso`, `nombre`, `prof_encargado`, `cuatrimestre`, `horario`, `rubrica_curso`, `annoLectivo`, `cod_Curso`, `inactivo`) VALUES
(1, 'Diseno', 'Pablo Castro', 'I cuatrimestre', 'Lunes', 'test', 0, '', NULL);
