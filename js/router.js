var routerApp = angular.module('routerApp', ['ngMaterial', 'ngMessages', 'ui.bootstrap.demo', 'ui.router', 'fileUpload', 'module', 'rutas', 'moduleDocs', 'moduleReport', 'crearGrupo', 'moduleHome', 'moduleProyectos', 'modulePerfil', 'modulePortafolio', 'modifyUser', 'agregarCarrera', 'agregarCurso', 'modifyCarrera', 'modifyCurso', 'moduleSocial', 'moduleVotacion']);
	...
	$scope.validate = function () {
		...
		if ($scope.userForm.$valid && userExist != true) {
			$scope.newUser = {
				...
				'Foto': ($('.thumb')
					.attr('ng-src')),
				'FechaNacimiento': ($('#inpFechaNacimiento')
					.val()),
				'Correo': $scope.email,
