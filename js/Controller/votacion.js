...
moduleVotacion.controller('VotacionCtrl', function($scope, $http) {
	...
	$scope.validarVotacion = function(){
		console.log((parseInt($('#inpFechaCierre').val())-parseInt($('#inpFechaInicio').val())));
		var dateIni = new Date($('#inpFechaInicio').val());
		var dateCierr = new Date($('#inpFechaCierre').val());
		
		
		//var newDateIni = new Date(dateIni.format("dd-m-yy"));
		//var newDateCierr = dateCierr.format("dd-m-yy");
		//console.log(newDateIni.getTime());
		//console.log(parseInt(newDateCierr)-parseInt(newDateIni));
